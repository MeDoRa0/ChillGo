...
class _HomeTabletLayoutState extends State<HomeTabletLayout> {
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 2,
                            child: _buildCrewLinksPanel(context),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildCrewLinksPanel(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFF1E1E2F),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildCrewLinkItem(
            ...
            title: 'Invitations',
            subtitle: 'Review pending invites',
            route: '/invitations',
          ),
        ],
      ),
