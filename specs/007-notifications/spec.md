...
- **FR-021**: System MUST support notification-center access, preference management, and best-effort device alerts on Android and iOS. Delivery MUST be attempted on every registered Android/iOS installation for the recipient that has granted permission; denied permission or provider unavailability MUST not make the in-app center unusable.
